...
---
#TODO
1. Is all we need the distance, in km, from 0 to 360 at given invervals?  In theory these distances should *not* change as a function of the lat-long origin point.  The lat-long of each distance point *will* change, but the *distance* itself will not.
